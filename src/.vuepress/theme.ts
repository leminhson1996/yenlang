...
export default hopeTheme({
  ...
  repo: "https://github.com/leminhson1996/yenlang",
  ...
  locales: {
    "/": {
      ...
      blog: {
        description: "Truyền tải những thông điệp từ cuộc sống đến với mọi người.",
        intro: "/intro.html",
      },
    ...
    */
    "/en/": {
      ...
      blog: {
        description: "Convey messages from life to everyone.",
        intro: "/intro.html",
      },
